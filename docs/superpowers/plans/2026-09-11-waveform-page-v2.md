...
**Placeholders.** None; every step has its code. The two test helpers are named exactly as they exist (`write16BitWAV` in the audio package) or defined in full (`writeHeaderOnlyWAV`, `writeHeaderOnly16BitWAV` in the API tests).
